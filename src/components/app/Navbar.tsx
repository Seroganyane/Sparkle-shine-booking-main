  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-[#07111f]/90 shadow-[0_8px_24px_rgba(2,6,23,0.35)] backdrop-blur-xl">
      <div className="container flex h-16 items-center justify-between gap-4">
        <Link to="/" aria-label="AquaLux home" className="font-display text-xl font-bold"><span className="bg-gradient-primary bg-clip-text text-transparent">AquaLux</span></Link>
